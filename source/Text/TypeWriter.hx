...
class TypeWriter extends FlxBitmapText
{
	 ...
	 */
	public function new(X:Float, Y:Float, Width:Int, Height: Int, Text:String, ?Color : Int = 0xFFFFFFFF, ?Size:Int = 6)
	{
        ...
        eachLineHeight = Size;
		targetHeight = Height;
		targetLines = Std.int(targetHeight / eachLineHeight);
	}
	...
	function preprocessText()
	{
		...
		// ??
		var lineWidth : Int = Std.int(width/eachLineHeight);
